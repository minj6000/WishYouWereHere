...
public class SaveBicycleReplay : MonoBehaviour
{
    ...
    static void SaveReplay()
    {
        if (Selection.activeGameObject != null)
        {
            ...
            File.WriteAllText(Application.dataPath + "/Simple Bicycle Physics/ReplayData.json", json);
        }
        else
    ...
    static void LoadReplay()
    {
        ...
        if (Selection.activeGameObject != null)
        {
            json = File.ReadAllText(Application.dataPath + "/Simple Bicycle Physics/ReplayData.json");
