...
namespace Michsky.DreamOS
{
    ...
    public class NotificationCreatorEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            DreamOSEditorHandler.DrawPropertyCW(notificationManager, customSkin, "Notification Manager", 132);

            if (ntfmcTarget.notificationManager == null)
            {
                GUILayout.BeginHorizontal();
                EditorGUILayout.HelpBox("'Notification Manager' is missing.", MessageType.Error);
