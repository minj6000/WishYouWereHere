...
namespace Michsky.DreamOS
{
    ...
    public class NotificationCreator : MonoBehaviour
    {
        ...
        {
            if (notificationType == NotificationType.Default) { notificationManager.CreateNotificationWithButtons(icon, title, description, notificationButtons, enableSound, true); }
            else if (notificationType == NotificationType.OnlyStandard) { notificationManager.CreateNotificationWithButtons(icon, title, description, notificationButtons, enableSound, false); }
            else if (notificationType == NotificationType.OnlyPopup) { notificationManager.CreatePopupNotification(icon, title, description, enableSound); }
        }
