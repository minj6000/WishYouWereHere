...
namespace Michsky.DreamOS
{
    public class NotificationManager : MonoBehaviour
    {
        ...
        public void CreateNotification(Sprite icon, string title, string description, bool createPopup = true, bool enableSound = true)
        {
            ...
            if (enableSound && audioManager != null) { audioManager.audioSource.PlayOneShot(UIManagerAsset.notificationSound); }
        ...
        public void CreatePopupNotification(Sprite icon, string title, string description, bool enableSound = true, AudioClip customSFX = null)
        {
            ...
            // Play sound if enabled
            if (enableSound && customSFX != null && audioManager != null) { audioManager.audioSource.PlayOneShot(customSFX); }
            else if (enableSound && audioManager != null) { audioManager.audioSource.PlayOneShot(UIManagerAsset.notificationSound); }
