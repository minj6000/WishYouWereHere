...
{
    [ExecuteInEditMode]
    public class ButtonManager : MonoBehaviour, IPointerDownHandler, IPointerClickHandler, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler, ISubmitHandler
    {
        // Content
...
#endif
            if (audioManager == null && useSounds && FindObjectsOfType(typeof(AudioManager)).Length > 0) 
            {
                audioManager = (AudioManager)FindObjectsOfType(typeof(AudioManager))[0];
            }
