        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    DreamOSEditorHandler.DrawProperty(selectTextObj, customSkin, "Select Text");
                    ...
                    DreamOSEditorHandler.DrawProperty(selectedImageObj, customSkin, "Select Image");
                    break;
                ...
                case 2:
                    ...
                    GUILayout.EndHorizontal();
                    GUILayout.Space(4);
                    if (useSounds.boolValue == true) { DreamOSEditorHandler.DrawProperty(audioManager, customSkin, "Audio Manager"); }
