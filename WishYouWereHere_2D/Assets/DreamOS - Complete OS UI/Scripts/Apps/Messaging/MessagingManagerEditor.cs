        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (mesTarget.currentEditorTab)
            {
                ...
                case 1:
                    ...
                    DreamOSEditorHandler.DrawPropertyCW(audioManager, customSkin, "Audio Manager", 130);
                    DreamOSEditorHandler.DrawPropertyCW(timeManager, customSkin, "Time Manager", 130);
                    ...
                    if (useNotifications.boolValue == true) { DreamOSEditorHandler.DrawPropertyCW(notificationManager, customSkin, "Notification Manager", 130); }
                    break;
