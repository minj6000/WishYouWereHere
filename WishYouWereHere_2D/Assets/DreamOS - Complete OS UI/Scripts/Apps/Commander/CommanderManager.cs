...
namespace Michsky.DreamOS
{
    public class CommanderManager : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            commandInput.text = "";
            UpdateColors();
            if (getTimeData && timeManager != null) { UpdateTime(); }
        ...
        void Awake()
        {
            ...
            if (getTimeData && timeManager == null && FindObjectsOfType(typeof(DateAndTimeManager)).Length > 0)
            {
                timeManager = (DateAndTimeManager)FindObjectsOfType(typeof(DateAndTimeManager))[0];
            }
        }
        ...
        {
            if (getTimeData && timeManager != null)
            {
