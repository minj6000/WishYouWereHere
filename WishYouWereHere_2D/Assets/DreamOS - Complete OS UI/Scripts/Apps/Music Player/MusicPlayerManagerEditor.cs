        ...
        public override void OnInspectorGUI()
        {
            ...
            switch (currentTab)
            {
                ...
                case 1:
                    ...
                    DreamOSEditorHandler.DrawPropertyCW(notificationManager, customSkin, "Notification Manager", 130);
                    break;
                ...
                case 2:
                    ...
                    if (enablePopupNotification.boolValue == true && notificationManager == null)
                    {
                        GUILayout.BeginHorizontal(EditorStyles.helpBox);
                        EditorGUILayout.HelpBox("'Notification Manager' is missing.", MessageType.Warning);
                        GUILayout.EndHorizontal();
                    }
