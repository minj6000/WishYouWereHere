...
namespace Michsky.DreamOS
{
    public class MusicPlayerManager : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            if (enablePopupNotification && notificationManager == null && FindObjectsOfType(typeof(NotificationManager)).Length > 0) { notificationManager = (NotificationManager)FindObjectsOfType(typeof(NotificationManager))[0]; }
        ...
        public void InstantiatePlaylistContent(MusicPlayerPlaylist targetPlaylist, Transform altTrackParent = null)
        {
            ...
            if (sortListByName == true) { targetPlaylist.playlist.Sort(SortByName); }
            ...
            for (int i = 0; i < targetPlaylist.playlist.Count; ++i)
            {
                ...
                // Set button BG color
                if (!checkerboardHelper) { tempTrack.backgroundImage.color = new Color32(255, 255, 255, 4); checkerboardHelper = true; }
                else { tempTrack.backgroundImage.color = new Color32(255, 255, 255, 0); checkerboardHelper = false; }
        ...
        public void NextTrack()
        {
            ...
            if (enablePopupNotification == true && notificationManager != null) 
            { 
                notificationManager.CreatePopupNotification(notificationIcon, currentPlaylist.playlist[currentTrackIndex].musicTitle, currentPlaylist.playlist[currentTrackIndex].artistTitle);
            }
        }
        ...
        public void PrevTrack()
        {
            ...
            // If notifications are on, then create one through the creator
            if (enablePopupNotification && notificationManager != null) 
            {
                notificationManager.CreatePopupNotification(notificationIcon, currentPlaylist.playlist[currentTrackIndex].musicTitle, currentPlaylist.playlist[currentTrackIndex].artistTitle);
            }
        }
