...
namespace Michsky.DreamOS
{
    public class UserManager : MonoBehaviour
    {
        ...
        float cachedLockScreenLength = 0.5f;
        ...
        void Awake()
        {
            ...
            if (lockScreen != null) { cachedLockScreenLength = DreamOSInternalTools.GetAnimatorClipLength(lockScreen, "LockScreen_PasswordIn") + 0.1f; }
        ...
        {
            yield return new WaitForSeconds(cachedLockScreenLength);
